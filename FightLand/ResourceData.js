...
var ResourceData= {
    Images:{
        //path：文件相對路徑，picNum:當前圖片中寬和高包含的小圖片數，cellSize:小圖片的寬和高，data：存放加載的圖片數據。
        //goddess_new:{path:"images/goddess_new.png", picNum:{WNum:4,HNum:4},cellSize:{width:32,height:48}, data:null}
        1:{path:"img/1.jpg", picNum:{WNum:1,HNum:1},cellSize:{width:105,height:150}, data:null,se:4,num:18}
        ,2:{path:"img/2.jpg", picNum:{WNum:1,HNum:1},cellSize:{width:105,height:150}, data:null,se:3,num:17}
        ...
        ,15:{path:"img/15.jpg", picNum:{WNum:1,HNum:1},cellSize:{width:105,height:150}, data:null,se:4,num:16}
        ...
        ,28:{path:"img/28.jpg", picNum:{WNum:1,HNum:1},cellSize:{width:105,height:150}, data:null,se:3,num:16}
        ...
        ,41:{path:"img/41.jpg", picNum:{WNum:1,HNum:1},cellSize:{width:105,height:150}, data:null,se:2,num:16}
        ...
        ,buchu:{path:"img/buchu.png", picNum:{WNum:1,HNum:1},cellSize:{width:100,height:50}, data:null}
        ,tishi:{path:"img/tishi.png", picNum:{WNum:1,HNum:1},cellSize:{width:100,height:50}, data:null}
        ,chupai:{path:"img/chupai.png", picNum:{WNum:1,HNum:1},cellSize:{width:100,height:50}, data:null}
        ,buqiang:{path:"img/buqiang.png", picNum:{WNum:1,HNum:1},cellSize:{width:130,height:50}, data:null}
        ,yf:{path:"img/yf.png", picNum:{WNum:1,HNum:1},cellSize:{width:130,height:50}, data:null}
        ,ef:{path:"img/ef.png", picNum:{WNum:1,HNum:1},cellSize:{width:130,height:50}, data:null}
        ,sf:{path:"img/sf.png", picNum:{WNum:1,HNum:1},cellSize:{width:130,height:50}, data:null}
    },
    Sound:{
        //soundName:聲音文件名稱，path：文件夾相對路徑，data：存放加載的聲音數據。由於各種瀏覽器對聲音格式的支持不一致，聲音文件格式有MP3和OGG兩種
