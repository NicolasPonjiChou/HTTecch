...
function cAudio(src) {
    ...
    audio.src = `audio/${src}.${format}`
    audio.volume = volume
    document.getElementById('Table').appendChild(audio)
...
$(document).ready(function () {
    ...
    function deal() {
        // 發牌
        if (event.target.className == 'Front') return
        cAudio('fapai')
        var h = 0
    ...
    function hit(entity) {
        if (GAME.hitting == false) {
            ...
            c.animate({
                rotate: parseInt(entity.rotate()),
                left: entity.offset().left + lo,
                top: entity.offset().top
            }, 300, function () {
                GAME.hitting = false
                var score = checkscore(entity).toString()
                if (score.indexOf('/') != -1) {
            ...
            if (special) {
                switch (special) {
                    ...
                    case 'surrender':
                        ...
                        message('Surrendered.')
                        mult = 0.5
                        $('#Player').find('.Wager .ChipSm').animate({
                            top: -600
                        }, 500, function () {
                            $(this).remove()
                        })
